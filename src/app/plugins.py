...
class Plugins:
    ...
    def __init__(self, plugins: Optional[Iterable[NFPlugin]] = None):
        self.plugins = set(plugins) if plugins else set()
    ...
    def load_plugin_dir(self, dir: Path):
        ...
        if dir.is_file():
            try:
                ...
                self.plugins.union(inspect.getmembers(plugin, nfsplugin_predicate))
    ...
    def load_prefixed_plugins(self, prefix: str):
        ...
        self.plugins.union(inspect.getmembers(new_plugins, nfsplugin_predicate))
